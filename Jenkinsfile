pipeline {
    ...
    environment {
        registry = "440833543191.dkr.ecr.us-east-1.amazonaws.com/devops/my-helm-repocc"
    }
    stages {
        stage('Checkout') {
            steps {
        ...
        stage ("Push to ECR") {
            steps {
                script {
                    ...
                    sh "docker push 440833543191.dkr.ecr.us-east-1.amazonaws.com/devops/my-helm-repocc:latest"
